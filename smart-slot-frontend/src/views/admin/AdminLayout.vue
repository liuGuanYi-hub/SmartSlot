  ...
  <div class="admin-container">
    ...
    <aside class="admin-sidebar">
      ...
      >
        ...
        <el-menu-item index="/admin/users" v-permission="['ROLE_ADMIN', 'ROLE_MANAGER']">
...
<script setup>
import { ref } from 'vue'
import { Platform, DataLine, Menu, List, Ticket, Document, Cpu, User } from '@element-plus/icons-vue'
